 ...
 *
 * @param {ManifesType} manifestLevel
 */
...
const mapFloors = 
	Array.from({ length: 5 }, (_, idx) => [idx.toString(), `${idx}_dark`])
	.flat()
	.map((floorName) => ({
		floorName,
